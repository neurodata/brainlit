...
if __name__ == "__main__":
    ...
    #%%
    swc_dir_path = Path(
        "/Users/bijanvarjavand/Documents/spring20/ndd/brainlit/tests"
    )
    ...
    if log:
        ...
        plt.scatter(total_lens_curv, total_mean_curvs, label="Segment Mean Curvature", alpha=0.01, s=4)
        plt.plot(total_lens_curv, total_mean_curvs_pred, label=line_lbl, color='red', linewidth=3)
        ...
        plt.scatter(total_lens_tor, total_mean_tors, label="Segment Mean Torsion", alpha = 0.01, s=4)
        plt.plot(total_lens_tor, total_mean_tors_pred, label=line_lbl, color='red', linewidth=3)
        plt.xlabel('Log Segment Length (um)', fontsize='x-large')
        plt.xticks(fontsize=12)
        ...
        plt.scatter(total_lens, total_mean_curvs, label="Segment Mean Curvature", alpha = 1, s=4)
        ...
        plt.scatter(total_lens, total_mean_tors, label="Segment Mean Torsion", alpha = 1, s=4)
        plt.plot(ls, est, 'r', label='Estimate')
        plt.xlabel('Segment Length (um)', fontsize='x-large')
        plt.xticks(fontsize=12)
