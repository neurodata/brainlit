...
ngl_sess = NeuroglancerSession(mip=1, url=brain_url, url_segments=segments_url,use_https=False)
...
for item in range(26,27,1):
    ...
    try:
        ...
        with napari.gui_qt():
            ...
            viewer.add_points(rel_centroids,size=5,symbol="o",face_color=np.array([0.67, 0.7, 1, 0.5]))
    except:
