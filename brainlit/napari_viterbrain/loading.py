...
im = zarr.open(
    "/Users/sejalsrivastava/brainlit/experiments/ViterBrain/data/example/3-1-soma.zarr",
    "r",
)
labels = zarr.open(
    "/Users/sejalsrivastava/brainlit/experiments/ViterBrain/data/example/3-1-soma_labels.zarr",
    "r",
)
