...
def test_contrast_normalize():
    ...
    assert(np.allclose(preprocessing.contrast_normalize(img), expected))
...
def test_window_pad_2D():
    ...
    assert(np.array_equal(padding, np.array([[1,1], [1,1]])))
    ...
    assert(np.array_equal(padding, np.array([[2,2], [2,0]])))
...
def test_window_pad_3D():
    ...
    assert(np.array_equal(padding, np.array([[1,1], [1,1], [1,1]])))
    ...
    assert(np.array_equal(padding, np.array([[2,2], [2,0], [2,2]])))
...
def test_vectorize_image():
    ...
    step_size = np.array([1,1])
    vector = preprocessing.vectorize_img(img, window_size, step_size)
    assert(np.array_equal(vector[:,0].flatten(), img[0:3, 0:3].flatten()))
    assert(np.array_equal(vector[:,5].flatten(), img[0:3, 5:8].flatten()))
    assert(np.array_equal(vector[:,8].flatten(), img[1:4, 0:3].flatten()))
    ...
    assert(np.array_equal(vector[:,0].flatten(), img[0:3, 0:3].flatten()))
    assert(np.array_equal(vector[:,5].flatten(), img[0:3, 5:8].flatten()))
    assert(np.array_equal(vector[:,8].flatten(), img[2:5, 0:3].flatten()))
...
def test_vectorize_image_3D():
    ...
    step_size = np.array([1,1,1])
    vector = preprocessing.vectorize_img(img, window_size, step_size)
    assert(np.array_equal(vector[:,0].flatten(), img[0:3, 0:3, 0:3].flatten()))
    assert(np.array_equal(vector[:,5].flatten(), img[0:3, 0:3, 5:8].flatten()))
    assert(np.array_equal(vector[:,8].flatten(), img[0:3, 1:4, 0:3].flatten()))
    ...
    assert(np.array_equal(vector[:,0].flatten(), img[0:3, 0:3, 0:3].flatten()))
    assert(np.array_equal(vector[:,5].flatten(), img[0:3, 0:3, 5:8].flatten()))
    assert(np.array_equal(vector[:,8].flatten(), img[0:3, 2:5, 0:3].flatten()))
