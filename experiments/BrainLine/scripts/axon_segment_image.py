...
ilastik_project = str(brainline_exp_dir / "data" / "models" / "axon" / "axon_segmentation.ilp")
...
ncpu = 4  # 16  # number of cores to use for detection
chunk_size = [512, 1024, 2304]  # [256, 256, 300]
