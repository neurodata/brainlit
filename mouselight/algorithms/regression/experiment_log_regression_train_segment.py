...
if read_whole:
    df = pd.read_csv('../large_files/features_01_22_all.csv',header=None,
        index_col=0)
else:
    df_iter = pd.read_csv('../large_files/neighborhood_01_22_25259.csv',header=None,
...
for j,file in enumerate(files):
    ...
    for i in range(0,num_pts,1):
        ...
        if save_fig:
            f,a = visualize.plot_image_mip([img0,img0_pred,img_proc],titles=['Image', 'Prob', 'Threshold'])
