...
class octree(object):
    def __init__(self, root_dir):
        ...
        print('spatial dimension of entire octree volume in um:', str(self.size_spatial))
    ...
    def voxel_path(self, vox, channel=0):
        ...
        for l in range(0,self.nl-1):
            ...
            split = np.greater(vox_cur,sz_cur-1) #get lower/upper half split boolean for 3 axis
